...
export function CliTerminal({ prompt, history, onRun, onClear, onReset }: Props) {
  ...
  return (
    <div className="rounded-lg border border-border bg-slate-950 text-slate-100 shadow-lg overflow-hidden flex flex-col h-[520px]">
      <div className="flex items-center justify-between border-b border-slate-800 px-3 py-2 bg-slate-900">
        <div className="flex items-center gap-1.5">
          ...
          <span className="ml-2 text-xs text-slate-400 font-mono">sandbox terminal</span>
        </div>
        <div className="flex items-center gap-1">
          ...
          <Button size="sm" variant="ghost" className="h-7 text-slate-300 hover:text-white hover:bg-slate-800" onClick={onReset}>
